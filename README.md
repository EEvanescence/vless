...
>
> اینجا [در این قسمت](#mahsang-gift-codes) من تعدادی کد هدیه از طرف اهداکنندگان پروژه مهسا قرار دادم که میتونید ازشون استفاده کنید، یه توضیح کوتاه میدم برای اونایی که نمیدونن نحوه استفاده از کد چجوریه.
>
> <br/>
>
> <details>
...
- [Amnezia](#amnezia)
- [MahsaNG gift-codes](#mahsang-gift-codes)
