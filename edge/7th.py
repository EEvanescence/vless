...
OUTPUT_FILE_WG = 'sub/wireguard7th'
OUTPUT_FILE_NEKO = 'sub/nekobox7th'
...
def wireguard_to_neko(wg_url):
    try:
        ...
        reserved_decimal = list(map(int, query.get('reserved', ['0'])[0].split(',')))
